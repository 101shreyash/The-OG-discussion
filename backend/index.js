...
app
  ...
  .post((req, res) => {
   ...
   if (password.length < 8) {
    ...
    async function DbCall() {
      ...
      await pool.query("INSERT INTO users (username,hash_password) VALUES ($1,$2)" , [username , hashedpassword]) 
  ...
  const token = jwt.sign({username : dbusername , userid : userid} , process.env.JWTKEY , {expiresIn : "2h"})
